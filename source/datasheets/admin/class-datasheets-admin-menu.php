...
class Datasheets_Admin_Menu {
    ...
    public function add_plugin_admin_menu() {
		...
		$menuIcon = 'dashicons-media-document';
        ...
        add_menu_page( __( 'Datasheets', 'datasheets' ), __( 'Datasheets', 'datasheets' ), 'manage_options', 'datasheets', array( $this, 'render_admin_menu_page' ), $menuIcon, 55.5 );
